        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | paginas-administrar-clientes-administrar-clientes-module */[__webpack_require__.e("common"), __webpack_require__.e("paginas-administrar-clientes-administrar-clientes-module")]).then(__webpack_require__.bind(null, /*! ../paginas/administrar-clientes/administrar-clientes.module */ "./src/app/paginas/administrar-clientes/administrar-clientes.module.ts")).then(m => m.AdministrarClientesPageModule)
            },
            {
                path: '',
            ...
            },
            {
                ...
                loadChildren: () => Promise.all(/*! import() | paginas-programar-visita-programar-visita-module */[__webpack_require__.e("default~paginas-administrar-clientes-ver-cliente-ver-cliente-module~paginas-programar-visita-program~2a0c3347"), __webpack_require__.e("paginas-programar-visita-programar-visita-module")]).then(__webpack_require__.bind(null, /*! ../paginas/programar-visita/programar-visita.module */ "./src/app/paginas/programar-visita/programar-visita.module.ts")).then(m => m.ProgramarVisitaPageModule)
            },
            {
                path: 'ver-cliente/:id_cliente',
                loadChildren: () => Promise.all(/*! import() | paginas-administrar-clientes-ver-cliente-ver-cliente-module */[__webpack_require__.e("default~paginas-administrar-clientes-ver-cliente-ver-cliente-module~paginas-programar-visita-program~2a0c3347"), __webpack_require__.e("common"), __webpack_require__.e("paginas-administrar-clientes-ver-cliente-ver-cliente-module")]).then(__webpack_require__.bind(null, /*! ../paginas/administrar-clientes/ver-cliente/ver-cliente.module */ "./src/app/paginas/administrar-clientes/ver-cliente/ver-cliente.module.ts")).then(m => m.VerClientePageModule)
            },
            {
                path: 'alta-cliente',
            ...
            },
            {
                ...
                loadChildren: () => Promise.all(/*! import() | paginas-administrar-servicios-administrar-servicios-module */[__webpack_require__.e("common"), __webpack_require__.e("paginas-administrar-servicios-administrar-servicios-module")]).then(__webpack_require__.bind(null, /*! ../paginas/administrar-servicios/administrar-servicios.module */ "./src/app/paginas/administrar-servicios/administrar-servicios.module.ts")).then(m => m.AdministrarServiciosPageModule)
            },
            {
