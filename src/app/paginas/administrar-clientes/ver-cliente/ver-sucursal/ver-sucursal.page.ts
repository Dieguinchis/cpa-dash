...
test($event) {
  console.warn($event)
  // window.open('http://192.168.100.100:3000/getZip')
}
...
descargarSucursal(){
  ...
  link.href = "http://192.168.100.100:3000/getfile/sucursales/"+this.sucursal.sucursal[0].id_sucursal ;
  link.click();
}
...
descargarQrEquipo(equipo){
  ...
  link.href = "http://192.168.100.100:3000/getfile/equipos/"+equipo.id_equipo;
  link.click();
}
...
descargarQrThisWorkstation(grupoEquipo){
  ...
  link.href = "http://192.168.100.100:3000/getZip?type=equipos&name="+grupoEquipo.nombre_equipo_grupo+"&data="+ids;
  link.click();
}
...
descargarAllQrSucursal(){
  ...
  var link = document.createElement("a");
  link.download = "qrs.png";
  link.href = "http://192.168.100.100:3000/getZip?type=all&name="+this.sucursal.sucursal[0].razon_social_sucursal+"&data="+ids;
  link.click();
...
descargarQrAllWorkstations(){
  ...
  var link = document.createElement("a");
  link.download = "qrs.png";
  link.href = "http://192.168.100.100:3000/getZip?type=equipos&name=equipos_"+this.sucursal.sucursal[0].razon_social_sucursal+"&data="+ids;
  link.click();
}
